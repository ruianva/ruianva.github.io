...
https://shimo.im/sheet/UFae1MU8GmUXUKeu/4WQG7
...
```
假设：1类的书特别多，有4004本；2-4类的书，每个类别有大约100本；每个书柜可放1000本书；
```

首先，1类书放在 1-4号柜，还剩4本，接下来的方法：
...
- 方案2（合并）：
  剩4本+ 2-4类的 1本书，全部放3号柜。





- 图书馆共12个书柜，每个书柜有20个抽屉，书柜下有轮子；
- 柜子的编号在于让学生更好的找
...
出于每个柜子都尽量使用的原则，柜的编号规则：

- 允许一个柜子 放多个大类的书（因为有些类别的书很少）；
- 
